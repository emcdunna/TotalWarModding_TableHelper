# UPDATED AT: 2018-01-23 10:19:11.468000
keyDict = {
...
"army_special_abilities_for_faction_junctions_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"audio_group_sounds_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"audio_technologies_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"banners_permitted_unit_sets_tables": ['unknown0', 'unknown1'], # has no unique columns, will check column groups instead
...
"cai_personalities_technology_research_path_junctions_tables": ['unknown0', 'unknown1'], # has no unique columns, will check column groups instead
...
"cai_personality_religious_components_tables": ['unknown0', 'unknown5', 'unknown6'], # Too many unique columns, will use them all
...
"campaign_storms_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"cdir_events_incident_followup_missions_tables": ['unknown0'], 
"cdir_events_incident_option_junctions_tables": ['id'], 
"cdir_events_incident_payloads_tables": ['id'], 
"cdir_events_mission_followup_dilemmas_tables": ['unknown0', 'unknown1'], # has no unique columns, will check column groups instead
...
"cultures_subcultures_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"effect_bonus_value_faction_junctions_tables": ['unknown1', 'unknown2'], # has no unique columns, will check column groups instead
...
"mortuary_cult_categories_tables": [None], # NO TSV FILES FOUND IN FOLDER
"mortuary_cult_categories_to_rituals_tables": [None], # NO TSV FILES FOUND IN FOLDER
"mounts_tables": ['key'], 
...
"pooled_resources_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"resource_cost_trade_resource_junctions_tables": [None], # NO TSV FILES FOUND IN FOLDER
"resource_ui_overrides_tables": [None], # NO TSV FILES FOUND IN FOLDER
"rituals_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"ritual_payload_ancillaries_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"ritual_payload_spawn_mercenaries_tables": [None], # NO TSV FILES FOUND IN FOLDER
"ritual_payload_spawn_storms_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"technology_character_traits_junctions_tables": [None], # NO TSV FILES FOUND IN FOLDER
"technology_effects_junction_tables": ['technology', 'effect'], # has no unique columns, will check column groups instead
"technology_nodes_tables": [None], # NO TSV FILES FOUND IN FOLDER
"technology_nodes_to_ancillaries_junctions_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"technology_ui_groups_tables": [None], # NO TSV FILES FOUND IN FOLDER
...
"ui_unit_group_parents_tables": ['unknown1'], 
